...
const Card = ({product}) => {
  return (
    <div className="max-w-sm mb-7 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
      <img
    ...
    <div className="p-5">
      ...
      <p className="mb-3 font-normal text-base text-gray-700 dark:text-gray-400">
        {product.description ? product.description : "Empty description"}
      </p>
      <a
        href="#"
